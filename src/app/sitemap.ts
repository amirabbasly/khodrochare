...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const regionPages: MetadataRoute.Sitemap = Object.values(seoRegions).map((region) => ({ url: `${baseUrl}/${region.citySlug}/${region.slug}`, lastModified, changeFrequency: "monthly" as const, priority: 0.8 }));
