...
import { allCities } from "@/content/coverage";
import { LinkGrid, Section } from "@/components/seo/landing-ui";
...
const relatedArticles: Record<string, { title: string; slug: string }[]> = {
  "roadside-assistance": [{ title: "امداد خودرو آنلاین چگونه کار می‌کند؟", slug: "online-roadside-assistance-request-guide" }, { title: "وقتی خودرو در بزرگراه خاموش می‌شود چه کنیم؟", slug: "what-to-do-when-car-stops-on-highway" }, { title: "خرابی خودرو در آزادراه تهران–کرج", slug: "tehran-karaj-freeway-breakdown-guide" }, { title: "امداد شبانه در تهران", slug: "tehran-night-roadside-guide" }, { title: "خرابی خودرو در جاده چالوس", slug: "chalus-road-breakdown-guide" }, { title: "مناطق تحت پوشش امداد خودرو تهران و کرج", slug: "car-assistance-coverage-tehran-karaj" }, { title: "امداد مطمئن یا تقلبی؟", slug: "tow-scam-avoidance-guide" }],
  "tow-truck": [{ title: "یدک‌کش خودرو اتوماتیک و حمل با کفی", slug: "automatic-car-towing-guide" }, { title: "راهنمای یدک‌کشی ایمن", slug: "safe-towing-guide" }, { title: "هزینه حمل خودرو با یدک‌کش در تهران و کرج", slug: "car-tow-truck-price-guide" }, { title: "خرابی خودرو در آزادراه تهران–کرج", slug: "tehran-karaj-freeway-breakdown-guide" }, { title: "خرابی خودرو در محور هراز", slug: "haraz-road-assistance-guide" }, { title: "حمل خودرو تهران–شمال", slug: "tehran-north-intercity-transport" }],
  "flatbed-carrier": [{ title: "یدک‌کش خودرو اتوماتیک و حمل با کفی", slug: "automatic-car-towing-guide" }, { title: "هزینه حمل خودرو با یدک‌کش و خودروبر", slug: "car-tow-truck-price-guide" }, { title: "امداد خودرو برقی و هیبریدی", slug: "ev-hybrid-roadside-safety-guide" }, { title: "تیگو ۷ پرو و قانون حمل CVT با کفی", slug: "tiggo-7-pro-cvt-tehran" }, { title: "حمل KMC K7 با کفی", slug: "kmc-k7-flatbed-guide" }, { title: "راهنمای یدک‌کشی ایمن", slug: "safe-towing-guide" }, { title: "دیگنیتی؛ توربو و حمل با کفی", slug: "dignity-roadside-guide" }, { title: "هایما S7؛ حمل ایمن شاسی‌بلند", slug: "haima-s7-tow-guide" }],
  "mobile-mechanic": [{ title: "مکانیک سیار چه تعمیراتی در محل انجام می‌دهد؟", slug: "mobile-mechanic-repairs-at-location" }, { title: "جوش آوردن خودرو در مسیر", slug: "car-overheating-roadside-guide" }, { title: "خرابی شاهین در تهران و کرج", slug: "shahin-roadside-tehran-karaj" }, { title: "دنا پلاس؛ مدیریت دما و توربو", slug: "dena-plus-overheat-guide" }, { title: "امداد خودرو برقی و هیبریدی", slug: "ev-hybrid-roadside-safety-guide" }, { title: "چک‌لیست انتخاب مکانیک سیار", slug: "mobile-mechanic-checklist" }, { title: "پژو پارس؛ خرابی و حمل", slug: "peugeot-pars-roadside" }, { title: "سمند و سورن؛ EF7 و جاده", slug: "samand-soren-roadside" }],
  "battery-replacement": [{ title: "نشانه‌های خرابی باتری خودرو", slug: "car-battery-warning-signs" }, { title: "باتری‌به‌باتری یا تعویض باتری؟", slug: "jumpstart-vs-battery-replacement" }, { title: "کوییک و ساینا؛ استارت و باتری", slug: "quick-saina-battery-starter" }, { title: "باتری خودرو در محل تهران و کرج", slug: "mobile-battery-replacement-tehran-karaj" }],
  "jump-start": [{ title: "نشانه‌های خرابی باتری خودرو", slug: "car-battery-warning-signs" }, { title: "باتری‌به‌باتری یا تعویض باتری؟", slug: "jumpstart-vs-battery-replacement" }, { title: "کوییک و ساینا؛ استارت و باتری", slug: "quick-saina-battery-starter" }],
  "vehicle-access": [{ title: "کلید داخل خودرو جا مانده یا گم شده", slug: "car-lockout-key-guide" }, { title: "امداد خودرو آنلاین چگونه کار می‌کند؟", slug: "online-roadside-assistance-request-guide" }],
  "pre-trip-check": [{ title: "بررسی فنی پیش از خرید خودرو کارکرده", slug: "pre-purchase-car-inspection-guide" }, { title: "چک‌لیست سرویس خودرو قبل از سفر", slug: "car-maintenance-before-long-trip" }, { title: "چک‌لیست خودرو سفر شمال", slug: "north-trip-car-checklist" }, { title: "رانندگی پاییزی در شمال", slug: "autumn-north-driving-guide" }],
  ...
  "mobile-diagnostics": [{ title: "چراغ چک روشن شده؛ چه زمانی به دیاگ سیار نیاز داریم؟", slug: "mobile-diagnostics-check-engine-guide" }, { title: "جک J7؛ چراغ چک و دیاگ", slug: "jac-j7-diagnostics-tehran" }, { title: "بررسی فنی پیش از خرید خودرو کارکرده", slug: "pre-purchase-car-inspection-guide" }],
  "fuel-delivery": [{ title: "وقتی خودرو در بزرگراه خاموش می‌شود چه کنیم؟", slug: "what-to-do-when-car-stops-on-highway" }, { title: "خرابی خودرو در آزادراه تهران–کرج", slug: "tehran-karaj-freeway-breakdown-guide" }, { title: "خرابی خودرو در جاده چالوس", slug: "chalus-road-breakdown-guide" }],
};
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return seoMetadata({ title: seoTitle, description: `${service.summary} هماهنگی تهران، کرج و شمال؛ عوامل هزینه و شرایط اعزام.`, path: `/services/${service.slug}`, keywords: [service.title, `${service.shortTitle} تهران`, `${service.shortTitle} کرج`, "امداد خودرو آنلاین"], image: service.image, imageAlt: service.title });
}

export default async function ServicePage({ params }: { params: Promise<{ slug: string }> }) {
  const service = getService((await params).slug);
  if (!service) notFound();
  const serviceFaqs = [...service.faqs, ...(serviceKnowledge[service.slug]?.faqs ?? [])];
  ...
  return (
    <SubpageShell>
      <StructuredData data={serviceSchema({ name: service.title, description: service.description, path: `/services/${service.slug}`, area: "محدوده پوشش", image: service.image })} />
      ...
      <section className="relative overflow-hidden bg-[#071a2e] text-white">
        ...
        <div className="site-container relative grid items-center gap-10 py-12 lg:grid-cols-[.9fr_1.1fr] lg:py-20" dir="ltr">
          ...
          <div className="text-right" dir="rtl"><SeoBreadcrumbs items={[{ label: "صفحه اصلی", href: "/" }, { label: "خدمات", href: "/services" }, { label: service.title }]} /><p className="mt-6 text-xs font-black text-slate-300">{service.eyebrow}</p><h1 className="mt-3 text-3xl font-black leading-[1.5] md:text-5xl">{{ "tow-truck": "یدک کش و حمل ایمن خودرو", "flatbed-carrier": "خودروبر و حمل خودرو با کفی", "mobile-mechanic": "مکانیک سیار و تعمیر خودرو در محل", "flat-tire": "پنچرگیری سیار و تعویض لاستیک در محل", "mobile-diagnostics": "دیاگ سیار و عیب‌یابی خودرو در محل", "mobile-carwash": "کارواش سیار و شست‌وشوی خودرو در محل" }[service.slug] ?? service.title}</h1><p className="mt-5 max-w-xl text-sm leading-8 text-slate-300">{service.description}</p><div className="mt-6 rounded-xl border border-white/15 bg-white/5 p-4 text-xs leading-7 text-slate-200"><strong className="text-white">مبنای هزینه: </strong>{service.priceNote}</div><div className="mt-6 flex flex-wrap gap-3"><Link href="/امداد-خودرو-آنلاین#request" className="inline-flex min-h-12 items-center gap-2 rounded-lg bg-brand-orange px-6 text-sm font-black shadow-orange"><Icon name="form" size={18}/> ثبت درخواست</Link><a href="tel:09123022064" className="inline-flex min-h-12 items-center rounded-lg border border-white/30 px-6 text-sm font-black" dir="ltr">09123022064</a></div></div>
        </div>
      </section>
