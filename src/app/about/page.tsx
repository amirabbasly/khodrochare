...
export default function AboutPage() {
  return <SubpageShell>
    ...
    <section className="site-container mt-8 grid gap-5 md:grid-cols-3" dir="rtl"><article className="overflow-hidden rounded-2xl bg-white shadow-card"><div className="relative h-40"><Image src="/images/facts/active-network.webp" alt="شبکه امدادگران فعال خودرو چاره" fill sizes="(min-width:768px) 33vw,100vw" className="object-cover" /></div><div className="p-6"><h2 className="font-black">پوشش مناطق تهران و کرج</h2><p className="mt-3 text-sm leading-7 text-slate-500">اعزام در مناطق ۲۲گانه تهران و مناطق فعال کرج و حومه هماهنگ می‌شود.</p><Link href="/coverage" className="mt-3 inline-flex text-xs font-black text-brand-orange">مشاهده همه مناطق ←</Link></div></article><article className="overflow-hidden rounded-2xl bg-white shadow-card"><div className="relative h-40"><Image src="/images/facts/fast-dispatch.webp" alt="اعزام سریع امداد خودرو" fill sizes="(min-width:768px) 33vw,100vw" className="object-cover" /></div><div className="p-6"><h2 className="font-black">اعزام معمولاً زیر ۳۰ دقیقه</h2><p className="mt-3 text-sm leading-7 text-slate-500">زمان دقیق به موقعیت، ترافیک، نوع خدمت و نزدیک‌ترین امدادگر آماده بستگی دارد.</p></div></article><article className="overflow-hidden rounded-2xl bg-white shadow-card"><div className="relative h-40"><Image src="/images/facts/support-24h.webp" alt="پشتیبانی شبانه‌روزی خودرو چاره" fill sizes="(min-width:768px) 33vw,100vw" className="object-cover" /></div><div className="p-6"><h2 className="font-black">مسیر مشخص رسیدگی</h2><p className="mt-3 text-sm leading-7 text-slate-500">برای پیگیری کیفیت خدمت یا ثبت شکایت، تماس مستقیم با پشتیبانی رسیدگی در دسترس است.</p></div></article></section>
