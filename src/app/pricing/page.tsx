...
export default function PricesPage() {
  return <SubpageShell>
    ...
    <section className="relative overflow-hidden bg-ink text-white"><div className="site-container relative py-14 md:py-20" dir="rtl"><span className="text-xs font-black text-orange-300">قیمت‌گذاری شفاف</span><h1 className="mt-5 text-3xl font-black md:text-5xl">قیمت خدمات امداد خودرو</h1><p className="mt-5 max-w-3xl text-sm leading-8 text-slate-300">هزینه هر خدمت به نوع خودرو، موقعیت، فاصله، تجهیزات و شرایط انجام کار بستگی دارد. اطلاعات سفارش بررسی و مبنای هزینه پیش از شروع خدمت با شما هماهنگ می‌شود.</p><div className="mt-6 flex flex-wrap gap-3"><Link href="/cost-calculator" className="rounded-lg bg-brand-orange px-5 py-3 text-sm font-black text-white">محاسبه آنلاین هزینه امداد</Link><Link href="/blog/car-tow-truck-price-guide" className="rounded-lg border border-white/30 px-5 py-3 text-sm font-black">راهنمای هزینه حمل خودرو</Link><Link href="/#request" className="rounded-lg border border-white/30 px-5 py-3 text-sm font-black">ثبت درخواست آنلاین</Link></div></div></section>
