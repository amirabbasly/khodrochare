...
export const metadata: Metadata = seoMetadata({ title: "قیمت خدمات امداد خودرو و خودرو در محل", description: "راهنمای قیمت خدمات خودرو چاره؛ امداد خودرو، یدک‌کش، خودروبر، باتری، پنچری و مکانیک سیار در شهرهای تحت پوشش.", path: "/pricing" });
