...
export const metadata: Metadata = seoMetadata({
  ...
  description: "راهنمای عوامل مؤثر بر قیمت امداد خودرو، یدک کش، خودروبر، باتری، پنچرگیری و مکانیک سیار در تهران و کرج؛ نحوه برآورد هزینه و اعلام مبلغ پیش از شروع خدمت.",
  path: "/pricing",
