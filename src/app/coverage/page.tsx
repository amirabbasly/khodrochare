...
export default function CoveragePage() {
  return <SubpageShell>
    <StructuredData data={breadcrumbSchema([{ name: "صفحه اصلی", path: "/" }, { name: "مناطق تحت پوشش" }], "/coverage")} /><StructuredData data={webPageSchema({ name: "مناطق تحت پوشش امداد خودرو خودرو چاره", description: "فهرست مناطق تحت پوشش امداد خودرو در تهران و کرج.", path: "/coverage", breadcrumb: true })} />
