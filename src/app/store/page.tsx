...
export const metadata: Metadata = seoMetadata({
  title: "فروشگاه قطعات و لوازم یدکی خودرو (به‌زودی)",
  description: "فروشگاه اینترنتی قطعات و لوازم یدکی خودرو چاره در حال آماده‌سازی است؛ تا زمان راه‌اندازی، تأمین قطعه از طریق خدمات امداد و مکانیک سیار هماهنگ می‌شود.",
  path: "/store",
  noindex: true,
});
...
export default function StorePage() {
  return (
    <SubpageShell>
      <StructuredData data={breadcrumbSchema([{ name: "صفحه اصلی", path: "/" }, { name: "فروشگاه" }], "/store")} />
      <section className="relative flex min-h-[70vh] items-center overflow-hidden bg-[#071a2e] py-20 text-white">
