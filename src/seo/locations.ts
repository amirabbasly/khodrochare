...
export const seoLocations = {
  tehran: { slug: "تهران", name: "تهران", region: "استان تهران", description: "امداد خودرو آنلاین و شبانه‌روزی در مناطق ۲۲گانه تهران با اعزام معمولاً کمتر از ۳۰ دقیقه، متناسب با ترافیک و موقعیت امدادگر.", keywords: ["امداد خودرو تهران", "امداد خودرو آنلاین تهران", "امداد خودرو شبانه روزی تهران"], areas: ["شمال تهران؛ نیاوران، زعفرانیه، تجریش و پاسداران", "شرق تهران و بزرگراه‌های امام علی، بابایی و باقری", "غرب تهران و مسیرهای همت، حکیم، ستاری و آزادگان", "مرکز و جنوب تهران", "مسیرهای اصلی و محدوده‌های پیرامونی قابل هماهنگی"] },
