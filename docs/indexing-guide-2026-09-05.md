...
به‌روزرسانی برای توسعه محتوای ۱۶ شهریور: [ابزارها، مقاله‌های تازه و شواهد کیفیت](growth-release-2026-09-07.md). فهرست canonical فعلی ۳۸۴ آدرس دارد.
...
| `https://khodrochare.ir/sitemap.xml` | XML معتبر، ۳۸۴ URL canonical |
...
- قرار نیست برای هر ۳۸۴ صفحه درخواست دستی تکراری بفرستید. sitemap و لینک‌های داخلی مسیر کشف کل مجموعه‌اند؛ درخواست دستی را به صفحات مهم اختصاص دهید و سهمیه‌ای که ابزار نمایش می‌دهد رعایت کنید.
...
### ابزارها و مقاله‌های نوبت جدید

پس از deploy، `/tools` و سه ابزار آن، `/pricing` و شش مقاله فهرست‌شده در [سند انتشار](growth-release-2026-09-07.md) را نیز با Test live URL بررسی کنید. تاریخ sitemap فقط برای محتوای واقعاً تغییرکرده به‌روز شده است؛ نیازی به درخواست دستی مکرر برای همه صفحات نیست.

## ۵. فهرست کامل URLها

[فایل کامل ۳۸۴ URL canonical](google-indexing-urls.txt) با اجرای `npm run indexing:export` از همان داده‌های مسیرهای سایت ساخته می‌شود. CI تطابق فایل و کد را کنترل می‌کند.
